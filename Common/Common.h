...
//The following definitions make file open operations to fail sometimes
...
#define myeof(file)                             (get_flen(file) == ftello(file))
...
void Taskbar_SetWindowNormal(HWND hWnd);
void Taskbar_SetWindowError (HWND hWnd);
void Taskbar_SetWindowPause (HWND hWnd);
#endif
